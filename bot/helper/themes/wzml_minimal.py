...
┠ <b>☢️OS Version :</b> {os_version}
┖ <b>☣️OS Arch :</b> {os_arch}
...
┠ <b>☁️GDrive Limit :</b> {GL} GB
┠ <b>📺YT-DLP Limit :</b> {YL} GB
┠ <b>🎥Playlist Limit :</b> {PL}
┠ <b>Ⓜ️Mega Limit :</b> {ML} GB
┠ <b>🎗️Clone Limit :</b> {CL} GB
...
------------------------------------------\n\n"""
  ...
  COUNT_MSG = '<b>🎲Cᴏᴜɴᴛɪɴɢ:</b><code>{LINK}</code>\n\n<b>⏳ Please Wait...</b>'
    ...
    LIST_NOT_FOUND = '☹️ℹNo result found for <i>{NAME}</i>'
    # ---------------------
...
<b><𝐏ᴏᴡᴇʀᴇᴅ 𝐁ʏ ››<a href="https://t.me/Star_linkz"><b>  STąR ✘ Ꝉҽҽçհ 🥂</b></a></b>'''
